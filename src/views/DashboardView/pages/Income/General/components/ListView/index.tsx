      ...
      >
        ...
        >
          <Typography
            ...
            variant="h4"
          >
            { t('income.general.charts.income_by_source') }
          </Typography>
          <SunburstWithLegend
            chartWidth={ chartWidth }
            className="chart-block"
            data={ incomeBySourceData }
            description={ t('income.general.charts.hint_description') }
            height={ 300 }
            legendLabels={ {
        ...
        >
          <Typography
            ...
            variant="h4"
          >
            { t('income.general.charts.income_by_income_type') }
          </Typography>
          <SunburstWithLegend
            chartWidth={ chartWidth }
            className="chart-block"
      ...
      <div className={ `${classes.root}-table` }>
        ...
        >
          <Table stickyHeader>
            ...
            <CustomTableBody
              customEmptyText={ t('income.general.table.no_data') }
