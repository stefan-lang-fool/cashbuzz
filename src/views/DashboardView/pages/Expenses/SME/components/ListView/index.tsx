      ...
      tempExpensesBySourceData.children = tempExpensesBySourceData.children
        ...
        .reduce((previous, currentValue, currentIndex) => {
          if (currentIndex < MAX_CHART_PARTS) {
            ...
            previous[MAX_CHART_PARTS].amount_total = Number((currentValue.amount_total + currentValue.amount_total).toFixed(2));
      ...
      >
        ...
        >
          <Typography
            ...
            variant="h4"
          >
            { t('expenses.sme.charts.expenses_by_source') }
          </Typography>
          <SunburstWithLegend
            chartWidth={ chartWidth }
            className="chart-block"
            data={ expensesBySourceData }
            description={ t('expenses.sme.charts.hint_description') }
            height={ 300 }
            legendLabels={ {
        ...
        >
          <Typography
            ...
            variant="h4"
          >
            { t('expenses.sme.charts.expenses_by_expenses_type') }
          </Typography>
          <SunburstWithLegend
            chartWidth={ chartWidth }
            className="chart-block"
      ...
      <div className={ `${classes.root}-table` }>
        ...
        >
          <Table stickyHeader>
            ...
            <CustomTableBody
              customEmptyText={ t('expenses.sme.table.no_data') }
